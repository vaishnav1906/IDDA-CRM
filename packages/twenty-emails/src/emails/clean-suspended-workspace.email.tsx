  ...
  return (
    <BaseEmail width={333} locale={locale}>
      ...
      <MainText>
        ...
        <br />
        <br />
        <Trans id="If you'd ever like to give IDDA CRM another try, you can start a fresh workspace in minutes — we'd love to have you back." />
      </MainText>
      <br />
      <CallToAction
        href="https://app.idda-crm.com/"
