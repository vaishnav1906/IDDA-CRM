...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  stage: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      options: [
        ...
        {
          id: 'a1b2c3d4-1001-4001-8001-000000000001',
          value: 'WON',
        ...
        {
          id: 'a1b2c3d4-1002-4002-8002-000000000002',
          value: 'LOST',
  ...
  subscriptions: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Subscriptions created from this won opportunity`),
      icon: 'IconReceipt',
      isUIEditable: false,
      isNullable: true,
