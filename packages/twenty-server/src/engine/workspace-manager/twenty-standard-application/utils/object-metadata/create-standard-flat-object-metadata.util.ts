...
export const STANDARD_FLAT_OBJECT_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  inAppNotification: ({
    ...
    CreateStandardObjectArgs<'inAppNotification'>,
    'context' | 'objectName'
  >) =>
    createStandardObjectFlatMetadata({
      objectName: 'inAppNotification',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier:
          STANDARD_OBJECTS.inAppNotification.universalIdentifier,
        nameSingular: 'inAppNotification',
        namePlural: 'inAppNotifications',
        labelSingular: i18nLabel(msg`Notification`),
        labelPlural: i18nLabel(msg`Notifications`),
        description: i18nLabel(msg`An in-app notification for a workspace member`),
        icon: 'IconBell',
        isSearchable: false,
        isSystem: true,
        duplicateCriteria: [],
  ...
  teamMember: ({
    ...
    twentyStandardApplicationId,
    now,
  }: Omit<CreateStandardObjectArgs<'teamMember'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'teamMember',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.teamMember.universalIdentifier,
        nameSingular: 'teamMember',
        namePlural: 'teamMembers',
        labelSingular: i18nLabel(msg`Team Member`),
        labelPlural: i18nLabel(msg`Team Members`),
        description: i18nLabel(
          msg`An IDDA employee record synced from workspace members`,
        ),
        icon: 'IconUsers',
        isSearchable: true,
        shortcut: 'T',
        duplicateCriteria: [['workEmail']],
        labelIdentifierFieldMetadataName: 'name',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
  ...
  visit: ({
    ...
    twentyStandardApplicationId,
    now,
  }: Omit<CreateStandardObjectArgs<'visit'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'visit',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.visit.universalIdentifier,
        nameSingular: 'visit',
        namePlural: 'visits',
        labelSingular: i18nLabel(msg`Visit`),
        labelPlural: i18nLabel(msg`Visits`),
        description: i18nLabel(
          msg`A verified field visit by an IDDA employee`,
        ),
        icon: 'IconMapPin',
        isSearchable: true,
        shortcut: 'V',
        duplicateCriteria: [],
        labelIdentifierFieldMetadataName: 'visitDate',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
  ...
  candidate: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`A sales or HR candidate`),
        icon: 'IconUserSearch',
        isSearchable: true,
        shortcut: 'A',
        duplicateCriteria: [['phone'], ['email']],
        labelIdentifierFieldMetadataName: 'name',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
