  ...
  company: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`A dental or dermatology clinic`),
  ...
  person: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        nameSingular: 'person',
        namePlural: 'people',
        labelSingular: i18nLabel(msg`Doctor`),
        labelPlural: i18nLabel(msg`Doctors`),
        description: i18nLabel(msg`A doctor or medical practitioner`),
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`An active IDDA subscription for a clinic or doctor`),
        icon: 'IconReceipt',
        isSearchable: true,
        shortcut: 'S',
  ...
  lead: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(
          msg`A prospect imported from MedLeads, pending qualification`,
        ),
        icon: 'IconTargetArrow',
        isSearchable: true,
        shortcut: 'L',
        duplicateCriteria: [['phone'], ['mapsUrl']],
        labelIdentifierFieldMetadataName: 'clinicName',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
